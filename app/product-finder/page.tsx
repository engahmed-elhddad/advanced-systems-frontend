...
import { API_BASE_URL, CATEGORIES } from '@/app/lib/constants'
                  ...
                  <tr className="border-b border-slate-200 bg-slate-50">
                    ...
                    {compareProducts.map(p => (
                      <th key={p.part_number} className="text-left px-4 py-3 font-medium">
                        <Link href={`/part-number/${encodeURIComponent(p.part_number)}`} className="font-mono text-primary-600 hover:underline">
                          {p.part_number}
                        </Link>
