        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center max-w-7xl mx-auto">
          ...
          <div className="flex flex-col text-center lg:text-left">
            ...
            <div className="flex flex-wrap gap-3 justify-center lg:justify-start mb-8">
              ...
              <Link
                href="/rfq/instant"
                className="inline-flex items-center justify-center px-6 py-3 rounded-[2px] bg-white/10 hover:bg-white/20 text-white font-semibold text-sm border border-white/20 transition-colors duration-150"
              >
