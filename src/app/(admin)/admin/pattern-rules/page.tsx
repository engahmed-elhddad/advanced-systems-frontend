...
export default function PatternRulesAdminPage() {
  ...
  async function loadBrands() {
    try {
      const res = await apiFetch(`${API}/admin/pattern-rules/brand`, { headers: headers() })
  ...
  async function loadCategories() {
    try {
      const res = await apiFetch(`${API}/admin/pattern-rules/category`, { headers: headers() })
      const data = await res.json()
  ...
  async function handleAddBrand(e: React.FormEvent) {
    ...
    setBrandSaving(true)
    try {
      await apiFetch(`${API}/admin/pattern-rules/brand`, {
        method: "POST",
        headers: headers(),
        body: JSON.stringify({
  ...
  async function handleDeleteBrand(id: number) {
    ...
    try {
      await apiFetch(`${API}/admin/pattern-rules/brand/${id}`, { method: "DELETE", headers: headers() })
      await loadBrands()
    } catch {
  ...
  async function handleAddCategory(e: React.FormEvent) {
    ...
    try {
      await apiFetch(`${API}/admin/pattern-rules/category`, {
        method: "POST",
        headers: headers(),
        body: JSON.stringify({
  ...
  async function handleDeleteCategory(id: number) {
    ...
    try {
      await apiFetch(`${API}/admin/pattern-rules/category/${id}`, { method: "DELETE", headers: headers() })
      await loadCategories()
    } catch {
      alert("Failed to deactivate")
    }
