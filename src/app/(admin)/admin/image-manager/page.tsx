    ...
    <div className="min-h-screen bg-industrial-gray-50 py-8 px-4">
      <div className="max-w-4xl mx-auto">
        <div className="flex items-center justify-between mb-8">
          ...
          <Link
            href="/admin"
            className="text-sm font-medium text-industrial-blue-600 hover:text-industrial-blue-700"
          >
            ← Back to Admin
          </Link>
        </div>
        ...
        <div className="rounded-xl border border-industrial-gray-200 bg-white p-6 shadow-sm mb-6">
          ...
          <div className="flex gap-2">
            <input
              ...
              className="flex-1 px-4 py-2.5 rounded-lg border border-industrial-gray-200 text-industrial-gray-900 placeholder-industrial-gray-400 focus:outline-none focus:border-industrial-blue-500 focus:ring-1 focus:ring-industrial-blue-500"
            />
            <button
              onClick={loadImages}
              disabled={loading || !partNumber.trim()}
              className="inline-flex items-center gap-2 px-4 py-2.5 rounded-lg bg-industrial-blue-600 hover:bg-industrial-blue-700 text-white font-medium disabled:opacity-50 disabled:cursor-not-allowed"
            >
        ...
        <div className="rounded-xl border border-industrial-gray-200 bg-white p-6 shadow-sm">
          <div className="flex items-center justify-between mb-4">
            ...
            {partNumber.trim() && (
              <label className="inline-flex items-center gap-2 px-3 py-2 rounded-lg border border-industrial-gray-200 hover:border-industrial-blue-500 hover:bg-industrial-blue-50 cursor-pointer text-sm font-medium text-industrial-gray-700">
              ...
              {images.map((img) => (
                ...
                >
                  <div className="aspect-square relative">
                    ...
                    />
                    {img.is_primary && (
                      <div className="absolute top-2 left-2 px-2 py-0.5 rounded bg-industrial-blue-600 text-white text-xs font-medium">
                        Primary
                      </div>
                    )}
                  </div>
                    ...
                    <div className="flex gap-1 shrink-0">
                      {!img.is_primary && (
                        <button
                          ...
                          className="p-1.5 rounded hover:bg-industrial-blue-50 text-industrial-blue-600"
